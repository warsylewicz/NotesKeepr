...
INSERT INTO note (id, title, content, owner_id, date_modified, date_created) VALUES (1, 'Josh and Admin\'s Costco List', '<ul><li>Bread</li><li>Butter</li><li>Milk</li><li>Tomatoes</li><li>Socks</li><li>Olive Oil</li><li>Tums</li></ul>', 1, (STR_TO_DATE('5/15/2013 8:06:26 AM', '%c/%e/%Y %r')), (STR_TO_DATE('5/15/2012 8:06:26 AM', '%c/%e/%Y %r')));
INSERT INTO note (id, title, content, owner_id, date_modified, date_created) VALUES (2, 'Honey ToDo List', 'Test2 - User Admin owns this note', 1, (STR_TO_DATE('5/16/2012 8:06:26 AM', '%c/%e/%Y %r')), (STR_TO_DATE('5/15/2012 8:06:26 AM', '%c/%e/%Y %r')));
INSERT INTO note (id, title, content, owner_id, date_modified, date_created) VALUES (3, 'Camping Packing List', 'Test3 - User Admin owns this note', 1, (STR_TO_DATE('5/23/2012 8:06:26 AM', '%c/%e/%Y %r')), (STR_TO_DATE('5/15/2012 8:06:26 AM', '%c/%e/%Y %r')));
INSERT INTO note (id, title, content, owner_id, date_modified, date_created) VALUES (4, 'Today\'s Chores', 'Test4 - User Josh owns this note', 2, (STR_TO_DATE('4/15/2012 8:06:26 AM', '%c/%e/%Y %r')), (STR_TO_DATE('5/15/2012 8:06:26 AM', '%c/%e/%Y %r')));
